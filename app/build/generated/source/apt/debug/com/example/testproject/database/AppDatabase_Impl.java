...
import com.example.testproject.database.dao.CoinDao_Impl;
    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        ...
        if (! _infoCoins.equals(_existingCoins)) {
          throw new IllegalStateException("Migration didn't properly handle coins(com.example.testproject.entity.coin.Coin).\n"
                  + " Expected:\n" + _infoCoins + "\n"
                  + " Found:\n" + _existingCoins);
        }
      }
